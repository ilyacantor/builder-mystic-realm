    ...
    <SiteLayout>
      <section className="container flex min-h-[60vh] items-center justify-center">
        <div className="w-full max-w-xl rounded-xl border border-white/10 bg-secondary/70 p-12 text-center shadow-card-soft">
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-primary">Error 404</p>
          <h1 className="mt-4 font-display text-3xl text-white">Page not found</h1>
          <p className="mt-4 text-sm text-foreground/70">
            The route <span className="text-primary">{location.pathname}</span> is outside the FlowNation system guidelines. Navigate back to the design system to continue building.
          </p>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button className="rounded-full bg-primary px-6 text-xs font-semibold uppercase tracking-[0.35em] text-primary-foreground hover:bg-primary/90" asChild>
